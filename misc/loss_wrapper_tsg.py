            ...
            if opt.structure_loss_weight > 0:
                gen_result, sample_logprobs = self.model(
                    ...
                    opt={
                        ...
                        "output_logsoftmax": opt.struc_use_logsoftmax
                        or opt.structure_loss_type == "softmax_margin"
                        or "margin" not in opt.structure_loss_type,
                ...
                struc_loss = {
                    "loss": torch.tensor(0).type_as(fc_feats),
                    "reward": torch.tensor(0).type_as(fc_feats),
                }
            loss = (
                1 - opt.structure_loss_weight
        ...
        # NOTE: SCST Loss
            ...
            with torch.no_grad():
                greedy_res, _ = self.model(
                    ...
                    mode="sample",
                    opt={
                        "sample_method": opt.sc_sample_method,
