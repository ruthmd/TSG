...
def parse_opt():
    ...
    parser.add_argument("--noamopt_rl", type=int, default=0, help="")
    ...
    parser.add_argument("--reduce_on_plateau_rl", type=int, default=0, help="")
    ...
    parser.add_argument(
        "--train_sample_n", type=int, default=16, help="The reward weight from cider"
    )
    ...
    # rl learning rate
    parser.add_argument(
        "--learning_rate_rl", type=float, default=5e-4, help="learning rate"
    )
    parser.add_argument(
        "--learning_rate_decay_every_rl",
        type=int,
        default=5,
        help="every how many iterations thereafter to drop LR?(in epoch)",
    )
    parser.add_argument(
        "--learning_rate_decay_rate_rl",
        type=float,
        default=0.85,
        help="every how many iterations thereafter to drop LR?(in epoch)",
    )
    ...
    parser.add_argument(
        "--kg_dir",
        type=str,
        default="data/kg/kg_info6.npy",
        help="the path if knowledge graph",
    )
    parser.add_argument(
        "--kg_size", type=int, default=512, help="size of the knowledge graph"
    )
    parser.add_argument(
        "--kge_index",
        type=str,
    ...
    parser.add_argument(
        "--kgfc_index", type=int, default=1, help="which version of kgfc is"
    )
    parser.add_argument(
        "--kglr_decay",
        type=float,
    ...
    parser.add_argument(
        "--kg_fix", type=int, default=0, help="fix knowledge graph dictionary or not"
    )
    parser.add_argument(
        "--mk_batch", type=int, default=0, help="extend mx to batchsize or not"
    )

    # memory of visual features related
    parser.add_argument(
        "--M_size", type=int, default=10000, help="the size of the memory"
    )
    ...
    parser.add_argument(
        "--memory_cell_path", type=str, default="0", help="memory cell path"
    )
    parser.add_argument(
        "--memory_init_decay", type=float, default=1, help="the decay of init memory"
    )
    parser.add_argument(
        "--mx_fix", type=int, default=0, help="fix visual feature dictionary or not"
    )
    parser.add_argument(
        "--mx_batch", type=int, default=0, help="extend mx to batchsize or not"
    )
    parser.add_argument(
        "--km_train", type=int, default=0, help="using k means to learn mx"
    )
    parser.add_argument("--km_alpha", type=float, default=0.98, help="alpha of k means")
    ...
    # whether use all previous words when sampling
    parser.add_argument(
        "--val_split", type=str, default="val", help="which set used to val"
    )
    ...
    parser.add_argument(
        "--batch_size_rl", type=int, default=10, help="the batch size when rl"
    )
    parser.add_argument(
        "--ga_index",
        type=int,
    ...
    parser.add_argument("--gelu_index", type=int, default=0, help="whether gelu or not")
    ...
    parser.add_argument(
        "--reset_rl_optimzer_index", type=int, default=1, help="reset or not"
    )
